...
set_target_properties(Parquet::parquet_shared PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libparquet.so.1400.2.0"
  IMPORTED_SONAME_RELEASE "libparquet.so.1400"
  )

list(APPEND _cmake_import_check_targets Parquet::parquet_shared )
list(APPEND _cmake_import_check_files_for_Parquet::parquet_shared "${_IMPORT_PREFIX}/lib/libparquet.so.1400.2.0" )
