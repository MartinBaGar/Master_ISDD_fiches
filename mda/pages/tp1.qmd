...
- [ ] Justify scaling  
Scaling permit features to vary in the same range and therefore makes comparisons and manipulations more efficient. However is it to note that choosing a scaling technique that doesn't suit our data can be more detrimental than not scaling the data.  
