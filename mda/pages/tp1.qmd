...
- [ ] Justify scaling  
Scalling permit features to vary in the same range and therefore makes comparisons and manipulations more efficient. However is it to note that chosing a scalling technique that doesn't suit our data can be more detrimental than not scalling the data.  
...
In classification, scaling the data is a key step that can have beneficial impacts on the upcoming manipulations. For example it:

- Normalises the data, hence prevents the domination of some features over others if they have different magnitudes.
- Sometimes handles better outliers by readjusting the range of the value
